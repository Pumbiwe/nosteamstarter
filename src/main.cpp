...
std::map<uintptr_t, std::vector<byte>> pdd_patches{
	...
	{0x0007ACD0, {0x31,0xC0,0xC2,0x08,0x00}},	// xor eax,eax; ret 8
	{0x000C8E20, {0x31,0xC0,0xC3}},				// xor eax,eax; ret
	{0x2CCC9F, {0x90, 0x90, 0x90, 0x90, 0x90}}, // nop
	{0xC84F0, {0x31, 0xc0, }},					// xor eax,eax
	{0xC84F2, {0xC2, 0x04, 0x00} },				// ret
};
